...
TASK_TO_ENCODINGS = {
    ...
    SequenceTask.SCORE_TO_TIME_PERFORMANCE_DECOUPLED: (
...
TASK_SEQUENCE_SORTING = {
    ...
    SortingType.TIME: {SequenceTask.TIME_PERFORMANCE, SequenceTask.TIME_PERFORMANCE_TO_SCORE},
    SortingType.ANY: {SequenceTask.PERFORMANCE},
}
